...
Voucherly is committed to adhering to the GDPR, the European Union regulation on protecting and transferring personal data and privacy within the EU and European Economic Area.

We take all necessary measures to ensure data protection, including:

- **Storing data** in certified data centers located within the EU, ensuring all data remains in compliance with regional regulations.
- **Encrypting and anonymizing** stored data as much as possible using advanced, dedicated software.
- **Implementing strict policies and guidelines**, including internal procedures and operational standards.
