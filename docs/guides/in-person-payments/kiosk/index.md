...
Please refer to [How Payments work](/guides/about/resources/payments-lifecycle/#payment-statuses) for more information about payment statuses.
:::
...
<Accordion>
    ...
    <>
        :::info
        Please refer to [Custom integration](/guides/online-payments/custom-integration) for a complete example.
        :::
        <GatewayFlowContent />
    </>
</Accordion>
