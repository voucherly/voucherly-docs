<>
    Voucherly offers a [GET PaymentGateways API](/api/webapi/list-payment-gateway) to fetch the active and available payment gateways for your merchant account.
    ...
    Additionally, Voucherly provides a [GET Customer's PaymentMethods API](/api/webapi/list-customer-payment-method) to retrieve a customer's saved payment methods.
