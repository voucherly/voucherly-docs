...
Voucherly is a technical service for merchants, not an Edenred reseller or commercial partner: your convention, your MID and your economic conditions are agreed directly with Edenred, and Voucherly never steps into that relationship. See [Voucherly and meal vouchers](../meal-vouchers/index.mdx) for how the roles are split.
...
If Edenred raises an objection or turns your request down, see [Edenred objections: how to respond](./objections.mdx).
:::
