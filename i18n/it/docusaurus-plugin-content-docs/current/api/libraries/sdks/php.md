---
slug: /api/librerie/sdk/php
sidebar_position: 2
description: "SDK PHP ufficiale di Voucherly, compatibile con PHP 5.6.0 e versioni successive, per integrare l'API di pagamento Voucherly."
keywords:
  - SDK PHP Voucherly
  - libreria PHP
  - Composer
...
La libreria PHP ufficiale di [Voucherly][voucherly], che supporta PHP 5.6.0 e versioni successive.

Consulta [Github](https://github.com/voucherly/voucherly-php-sdk).
